    ...
    <section id="top" className="relative overflow-hidden min-h-screen flex items-center pt-32">
      ...
      >
        ...
        >
                ...
                >
                  <span className="gradient-text-white">The only GTM agency that cares about one thing…</span>
                  <br />
                  <motion.span
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
          ...
          <motion.p 
            ...
            className="text-base sm:text-lg md:text-xl text-slateLight max-w-4xl mx-auto mb-12 md:mb-16 leading-relaxed"
          >
          ...
          >
            <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-2 border border-white/10 shadow-2xl">
              <form className="flex flex-col sm:flex-row gap-2">
                ...
                <motion.button
                  type="submit"
                  className="px-8 py-4 bg-gradient-to-r from-emerald-500 to-teal-400 text-white font-bold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 text-lg"
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                >
                  Press Send
