      ...
      <div className="w-full max-w-7xl mx-auto container-padding">
        ...
        >
          <motion.button
            ...
            className="px-12 py-6 text-xl font-bold bg-gradient-to-r from-emerald-500 to-teal-400 text-white rounded-2xl hover:scale-105 transition-all duration-300 shadow-2xl hover:shadow-emerald-500/25 border-2 border-transparent hover:border-white/20"
